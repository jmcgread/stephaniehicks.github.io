...
\textit{quantro}: An R-package that can be used to test for differences between groups of distributions to \\
 \hspace{0.5in} guide the choice if quantile normalization should be used [\href{http://www.bioconductor.org/packages/release/bioc/html/quantro.html}{Available on Bioconductor}]\\
