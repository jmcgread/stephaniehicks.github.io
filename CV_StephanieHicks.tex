...
My research interests are focused on developing statistical methods, tools and software for the analysis of genomics data. Specifically, my research addresses statistical challenges in epigenomics, functional genomics and single-cell genomics such as the pre-processing, normalization, analysis of raw high-throughput data (microarray and next-generation sequencing) leading to an improved quantification and understanding of biological variability. This work resulted in a \href{https://projectreporter.nih.gov/project_info_description.cfm?aid=9243746&icde=32574421&ddparam=&ddvalue=&ddsub=&cr=1&csb=default&cs=ASC&pball=}{K99/R00 grant} from the \href{https://www.genome.gov}{National Human Genome Research Institute (NHGRI)}. 
...
\item{\bf Hicks SC}, Irizarry RA. (2016). A Guide to Teaching Data Science. {\it arXiv} and under review at {\it The American Statistician}. \url{https://arxiv.org/abs/1612.07140}. 
\item {\bf Hicks SC}, Okrah K, Paulson JN, Quackenbush J, Irizarry RA, Bravo HC. (2016). Smooth Quantile Normalization. {\it bioRxiv} and under review at {\it Biostatistics}. doi: \url{http://dx.doi.org/10.1101/085175}. 
\item {\bf Hicks SC}, Teng M, Irizarry RA. (2015). On the widespread and critical impact of systematic bias and batch effects in single-cell RNA-Seq data. {\it bioRxiv}. doi: \url{http://dx.doi.org/10.1101/025528}. 
\end{enumerate}
...
\textbf{Invited Talks} 
\begin{enumerate}[label= {[\arabic*]}]
	\item \href{https://github.com/hms-dbmi/scw/tree/master/scw2016/tutorials/batcheffects}{Batch effects and technical biases in scRNA-Seq data}. \href{http://hsci.harvard.edu/event/save-date-single-cell-analysis-workshop}{HSCI Single-Cell Workshop}. 2016 Nov 29-30. Harvard Medical School, Boston, MA. 
	...
	\item On the widespread and critical impact of systemic bias and batch effects in single-cell RNA-seq data. \href{https://www.amstat.org/meetings/jsm/2016/onlineprogram/MainSearchResults.cfm}{{\it Joint Statistical Meetings}}. 2016 July 31-Aug 4. Chicago, IL.
	\item On the widespread and critical impact of systemic bias and batch effects in single-cell RNA-seq data. \href{http://hsci.harvard.edu/event/widespread-and-critical-impact-systemic-bias-and-batch-effects-single-cell-rna-seq-data?delta=0}{{\it Boston Single-Cell Network Meeting}}. 2016 March 15. Boston, MA.
	\item Introduction to R and R Package Demonstration. Dept of Biostatistics and Computational Biology Training Sessions. Dana-Farber Cancer Institute. 2016 March 9. Boston, MA. 
	\item \href{https://speakerdeck.com/stephaniehicks/why-statistics-matters-in-the-analysis-of-genomics-data}{Why Statistics Matters in the Analysis of Genomics Data}. Computational Biology Seminar, Department of Biology, Louisiana State University. 2015 Feb 11. Baton Rouge, LA. 
...
\begin{enumerate}[label= {[\arabic*]}]
	\item {\bf Hicks SC}. Transforming the Classroom to Teach Statistics and Data Science with Active Learning. \href{http://www.amstat.org/meetings/wsds/2016/}{{\it Women in Statistics and Data Science Conference}}. 2016 Oct 20-22. Charlotte, NC. 
	\item {\bf Hicks SC}\footnote{Selected for a Stellar Abstract Award}, Teng M, Irizarry R. On the widespread and critical impact of batch effects and systematic bias in single-cell RNA-Seq data. \href{https://www.hsph.harvard.edu/2015-pqg-conference/}{PQG Conference: {\it Single-cell Genomics: Technology, Analysis, and Applications}}. 2015 Nov 5-6. Boston, MA.
	\item {\bf Hicks SC}, Irizarry R. quantro: When should you use quantile normalization? Flashlight talk at \href{https://www.bioconductor.org/help/course-materials/2014/BioC2014/}{\emph{Bioconductor Conference}}. 2014 Jul 30-Aug 1. Boston, MA. 
...
\emph{Bioinformatics, Biometrics, BMC Medical Genetics, Genome Biology, Human Mutation, PLoS Computational Biology, PLoS One}
