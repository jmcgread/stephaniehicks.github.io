...
\item {\bf Hicks SC}, Townes FW, Teng M, Irizarry RA. (2017). Missing Data and Technical Variability in Single-Cell RNA-Sequencing Experiments. {\it bioRxiv}. doi: \url{http://dx.doi.org/10.1101/025528}. 
\end{enumerate}

\textbf{Peer-reviewed Journal Articles}
\begin{enumerate}[label= {[\arabic*]}]
\item{\bf Hicks SC}, Irizarry RA. (2017). A Guide to Teaching Data Science. {\it arXiv} and in press at {\it The American Statistician}. \url{https://arxiv.org/abs/1612.07140}. 
