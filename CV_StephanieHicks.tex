...
\begin{table}[h]
\begin{tabular}{ll}
2015 & \textbf{ROpenSci Unconference} (\href{http://unconf.ropensci.org}{unconf.ropensci.org}), GitHub, San Francisco, CA \\
& Invited to work with over 40 R enthusiasts from industry, academia, non-profits and government \\
& on projects supporting open data, open science and data visualization in R.  \\
