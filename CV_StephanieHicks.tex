...
\textbf{Invited Talks} 
\begin{enumerate}[label= {[\arabic*]}]
	\item On the widespread and critical impact of systemic bias and batch effects in single-cell RNA-seq data. \href{http://hsci.harvard.edu/event/widespread-and-critical-impact-systemic-bias-and-batch-effects-single-cell-rna-seq-data?delta=0}{Boston Single-Cell Network Meeting}. 2016 March 15. Boston, MA.
...
\begin{enumerate}[label= {[\arabic*]}]
	\item {\bf Hicks S}\footnote{Selected for a Stellar Abstract Award}, Teng M, Irizarry R. On the widespread and critical impact of batch effects and systematic bias in single-cell RNA-Seq data. 2015 PQG Conference: {\it Single-cell Genomics: Technology, Analysis, and Applications}. 2015 Nov 5-6. Boston, MA.
	\item {\bf Hicks SC}, Irizarry R. quantro: When should you use quantile normalization? Flashlight talk at \emph{Bioconductor Conference}. 2014 Jul 30-Aug 1. Boston, MA. 
...
\begin{table}[h]
\begin{tabular}{ll}
2015 & Stellar Abstract Award for the 2015 PQG Conference \\
...
%\begin{table}[h]
%\begin{tabular}{ll}
2017 - 2019 \hspace{0.5in} Member of \href{https://www.amstat.org/committees/commdetails.cfm}{ASA Committee on Women in Statistics}
%\end{tabular}
%\end{table}
