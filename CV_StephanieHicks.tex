...
\begin{table}[h]
\begin{tabular}{ll}
2015 & \textbf{Contributor}, Harvard edX \\ 
& \href{https://courses.edx.org/courses/HarvardX/PH525.1x/1T2015/info}{Statistics and R for the Life Sciences
(PH525.1x)} \\
& \href{https://courses.edx.org/courses/HarvardX/PH525.8x/1T2015/info}{Case study: DNA methylation data analysis (PH525.8x)} \\
& \textit{Contributed course material, created screencasts, developed assessments, answered questions} \\
& \textit{Courses taught by Rafael Irizarry with Teaching Assistant Mike Love.} \\
& \\
